module SystemT where
  ...
  open import CFramework.CTerm C renaming (Λ to Term) --public
  ...
  open import CFramework.CReduction C _▹T_ as Reduction renaming (_⟿_ to _→β_) public
  ...
  lemma*◃T x*M (beta M▹βN) = antipreser▹β* x*M M▹βN
  ...
  compat▹T∙ (beta M▹βN) = mapΣ id (mapΣ beta id) (compat▹β∙ M▹βN) -- Does make sense NOT to have ▹β in the definition of ⟿?
